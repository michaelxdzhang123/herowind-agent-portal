...
2.3.1 Get BeaverFramework:
--------------------------

.. code-block:: bash

        git clone git@gitee.com:michaelxdzhang/beaver-framework.git 
        cd beaver-framework && pip install -e .

2.3.2 Get repo of BladeAI:
------------------
